...
// Agregamos el evento click a los botones, adicionalmente se le agrega la función que realizará la operación
...
function sumar() {
    let numero1 = Number(prompt("Ingrese el primer número a sumar"));
    let numero2 = Number(prompt("Ingrese el segundo número a sumar"));
    resultado = numero1 + numero2;
    parrafo.innerHTML = `${numero1} + ${numero2} = ${resultado}`;
}

function restar() {
    let numero1 = Number(prompt("Ingrese el primer número a restar"));
    let numero2 = Number(prompt("Ingrese el segundo número a restar"));
    resultado = numero1 - numero2;
    parrafo.innerHTML = `${numero1} - ${numero2} = ${resultado}`;
}
...
function dividir() {
    let numero1 = Number(prompt("Ingrese el primer número a dividir"));
    let numero2 = Number(prompt("Ingrese el segundo número a dividir"));
    let mensaje;
